...
const SMS_SCHEDULE_MSG_ALERT_LIST_TEMPLATE_USED = '登録対象日付に同じ送信リストとテンプレートが存在しています。\n';
...
const SMS_SCHEDULE_MSG_ALERT_SAME_OTHER_SCHEDULE = '登録対象日付に同じ送信リストと送信テンプレートが存在します。\n';
...
const OUTBOUND_EXPORT_EXIST_QUESTION_SMS = 'SMSセクションが存在するため、エクスポートできません。';
