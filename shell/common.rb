...
# メールアカウントを初期化する。
# 例）
# initMail('smtp.office365.com', 'ascend-corp.co.jp', 'astar_report@ascend-corp.co.jp', 'wEkUPc&sjv4ykn%6VZyW')
#
###########################################
...
def sendMailError(schedule_id, message = "")
	instance =  AscConfig.new
	instance.instance_eval File.read File.join(File.dirname(__FILE__),'config.ini')
	config = instance.getData
    ...
    body = body + "※資料の場所：\\\\10.121.0.241\\ascend-sjk\\事業部フォルダ\\システム事業部\\91_システム障害手順\\はやぶさ_公明党\r\n"
